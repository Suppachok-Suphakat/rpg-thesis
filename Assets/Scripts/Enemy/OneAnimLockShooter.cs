...
public class OneAnimLockShooter : MonoBehaviour, IEnemy
{
    ...
    private IEnumerator AttackWithDelay()
    {
        ...
        // Trigger the single attack animation
        animator.SetTrigger("Attack"); // This is the single attack animation for this enemy
    }
