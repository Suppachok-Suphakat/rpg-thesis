...
public class Sword : MonoBehaviour, IWeapon
{
    ...
    public void SkillActivate()
    {
        ...
        weaponCollider.gameObject.SetActive(true);
        swordAbilityAnim = Instantiate(swordAbilityAnimPrefab, PlayerController.instance.transform.position, Quaternion.identity);
        if (PlayerController.instance.FacingLeft)
        {
            swordAbilityAnim.GetComponent<SpriteRenderer>().flipX = true;
        }
        swordAbilityAnim.transform.parent = this.transform.parent;
    }
