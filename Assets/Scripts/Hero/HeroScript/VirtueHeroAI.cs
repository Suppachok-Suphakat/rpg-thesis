...
public class VirtueHeroAI : MonoBehaviour
{
    ...
    public VirtueHeroSkill virtueHeroSkill;
    ...
    private void Awake()
    {
        ...
        skill = gameObject.GetComponent<VirtueHeroSkill>();

        virtueHeroSkill = GetComponent<VirtueHeroSkill>();
